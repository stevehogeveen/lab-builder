...
def react_ui_action_inventory() -> dict[str, list[dict[str, str]]]:
    return {
        ...
        "cisco": [
            ...
            {"label": "Apply Access Configs", "method": "POST", "route": "/modules/cisco/bootstrap-management", "mode": "legacy-html"},
        ...
        "storage": [
            ...
            {"label": "Reboot Machine Now", "method": "POST", "route": "/reboot-storage-now", "mode": "legacy-html"},
            {"label": "Reboot Now", "method": "POST", "route": "/reboot-storage-now", "mode": "legacy-html"},
            {"label": "Retry Reboot Now", "method": "POST", "route": "/reboot-storage-now", "mode": "legacy-html"},
            {"label": "Approved", "method": "POST", "route": "/approve-storage-plan", "mode": "legacy-html"},
            {"label": "View storage artifact", "method": "POST", "route": "/view-storage-artifact", "mode": "legacy-html"},
            {"label": "View Apply Log", "method": "POST", "route": "/view-storage-artifact", "mode": "legacy-html"},
            {"label": "View Apply Results", "method": "POST", "route": "/view-storage-artifact", "mode": "legacy-html"},
            {"label": "View details", "method": "POST", "route": "/view-storage-artifact", "mode": "legacy-html"},
            {"label": "View discovery summary", "method": "POST", "route": "/view-storage-artifact", "mode": "legacy-html"},
            {"label": "View raw discovery", "method": "POST", "route": "/view-storage-artifact", "mode": "legacy-html"},
        ...
        "reports": [
            ...
            {"label": "Open run summary", "method": "POST", "route": "/view-report", "mode": "legacy-html"},
            {"label": "Open storage plan used", "method": "POST", "route": "/view-report", "mode": "legacy-html"},
