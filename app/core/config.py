...
def default_config() -> dict[str, Any]:
    return KitConfigModel(
        ...
        cisco_switch={
            ...
            "port_profiles": {
                "client_device": {"mode": "access", "access_vlan": 10, "description": "Client Device", "enabled": True, "cdp": False, "lldp": True, "snmp_trap_link_status": True, "spanning_tree_portfast": True, "bpduguard": True},
                "unused_blackhole": {"mode": "access", "access_vlan": 999, "description": "UNUSED", "enabled": False, "cdp": False, "lldp": True, "snmp_trap_link_status": False, "spanning_tree_portfast": True, "bpduguard": True},
                "uplink_trunk": {"mode": "trunk", "description": "Uplink", "enabled": True, "cdp": True, "lldp": True, "snmp_trap_link_status": True, "spanning_tree_portfast": False, "bpduguard": False, "allowed_vlans": [10, 999]},
                "server_esxi": {"mode": "trunk", "description": "ESXi Server", "enabled": True, "cdp": True, "lldp": True, "snmp_trap_link_status": True, "spanning_tree_portfast": True, "bpduguard": False, "allowed_vlans": [10]},
                "netapp_storage": {"mode": "trunk", "description": "NetApp Storage", "enabled": True, "cdp": True, "lldp": True, "snmp_trap_link_status": True, "spanning_tree_portfast": True, "bpduguard": False, "allowed_vlans": [10]},
                "access_point": {"mode": "trunk", "description": "Access Point", "enabled": True, "cdp": False, "lldp": True, "snmp_trap_link_status": True, "spanning_tree_portfast": True, "bpduguard": True, "allowed_vlans": [10], "native_vlan": 10},
                "printer": {"mode": "access", "access_vlan": 10, "description": "Printer", "enabled": True, "cdp": False, "lldp": True, "snmp_trap_link_status": True, "spanning_tree_portfast": True, "bpduguard": True},
                "custom": {"mode": "access", "access_vlan": 10, "description": "Custom", "enabled": True, "cdp": False, "lldp": True, "snmp_trap_link_status": True, "spanning_tree_portfast": False, "bpduguard": False},
            },
            "ports": {
                "GigabitEthernet1/0/1": {"profile": "client_device", "description": "Client Device", "cdp": True, "spanning_tree_portfast": False, "bpduguard": False},
            ...
            "custom_port_commands": {
                "GigabitEthernet1/0/3": {"after_profile": ["storm-control broadcast level 5.00", "storm-control multicast level 5.00"]},
            },
